...
libraryDependencies ++= {
  ...
  val pekkoHttpCirceVersion   = "2.8.0"
  ...
  val jakartaXmlBindVersion   = "4.0.4"
  ...
  Seq(
    ...
    "com.github.pjfanning" %% "pekko-http-circe"     % pekkoHttpCirceVersion excludeAll ExclusionRule(organization = "io.circe"),
    // JWT
    ...
    "org.apache.shiro" % "shiro-lang"  % shiroVersion,
