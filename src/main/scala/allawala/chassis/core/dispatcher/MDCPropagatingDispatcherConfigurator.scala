package allawala.chassis.core.dispatcher
...
/**
  ...
  * See https://github.com/rishabh9/mdc-propagation-dispatcher/blob/master/src/main/scala/com/github/rishabh9/MDCPropagatingDispatcherConfigurator.scala
